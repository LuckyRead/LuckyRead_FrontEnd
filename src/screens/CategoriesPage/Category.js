...
import SubTopics from "./Sub_topics";
  ...
  handleClick = e => {
    ...
    if (checked === true) {
      ...
      axios({
        method: "post",
        url:
          "https://luckyread-backend.herokuapp.com/api/topic/add_pref/" +
          this.props.id,
        headers: {
          Authorization: "Bearer " + localStorage.jwtToken
        }
      ...
      axios({
        method: "delete",
        url:
          "https://luckyread-backend.herokuapp.com/api/topic/rm_pref/" +
          this.props.id,
        headers: {
          Authorization: "Bearer " + localStorage.jwtToken
        }
    ...
    return (
      <Card className="Item">
        ...
        <Collapse isOpen={this.state.collapse} id="Collapse">
          <CardBody>
            <CardText>{domSubTopics}</CardText>
          </CardBody>
        </Collapse>
      </Card>
    );
